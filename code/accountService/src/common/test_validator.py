...
def genFakeID():
    print
    print (validator.fake_id(True, '江苏省', '20000101', 1))
    print (validator.fake_id(True, '重庆市', '19970203', 1))
    print (validator.fake_id(True, '重庆市', '19960708', 1))
    print (validator.fake_id(True, '重庆市', '19820305', 0))
    print (validator.fake_id(True, '重庆市', '19660705', 1))
    print (validator.fake_id(True, '重庆市', '19910312', 0))    
    print (validator.fake_id(True, '重庆市', '19960718', 1))
    print (validator.fake_id(True, '重庆市', '19920315', 0))
    print (validator.fake_id(True, '北京市', '19920315', 0))
    print (validator.fake_id(True, '上海市', '19930718', 1))

...
import accountAppPost as userApp #modify here

_processorPID = os.getpid()

appName = "accountApp" #modify here
routeAddr = "/acis" #modify here
...
if "_LOG" not in dir() or not _LOG:
    _LOG = misc.setLogNew(comGD._DEF_ACCOUNT_LOG_TITLE, comGD._DEF_ACCOUNT_LOG_NAME) #modify here

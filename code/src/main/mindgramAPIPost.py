    ...
    try:
        ...
        if tempUserID != "":
            ...
            if errCode == "B0": #
                ...
                forceFlashFlag = dataSet.get("forceFlashFlag",comGD._CONST_NO) #�Ƿ�ǿ�Ʋ�ѯ(ˢ��)���
                ...
                if rightCheckFlag:
                    ...
                    if not(useQueryBufferFlag and chkBufferExist(indexKey)) or forceFlashFlag == comGD._CONST_YES:
                        ...
                        if searchOption:
                            ...
                            allowList = ["description", "label"] #ɸѡ�ֶ�
                            serachResultSet = comFC.handleSearchOption(searchOption,allowList, allDataList)
                            if serachResultSet["rtn"] == "B0":
                                currDataList = serachResultSet.get("data", [])
                        else:
                        ...
                        #��ʱ�������,�Ľ���, 2023/10/16
                        indexKey = putQuery2Buffer(indexKey, dataList) #������ݵ���ʱ������ȥ
